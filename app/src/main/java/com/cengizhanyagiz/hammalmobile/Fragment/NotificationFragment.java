...
import com.cengizhanyagiz.hammalmobile.Adapters.Friend_Req_Adapter;
...
public class NotificationFragment extends Fragment {
    ...
    RecyclerView friend_req_RecylerView;
    ...
    public void tanimla()
    {
        ...
        friend_req_RecylerView =(RecyclerView) view.findViewById(R.id.friend_req_RecylerView);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getContext(),1);
        friend_req_RecylerView.setLayoutManager(layoutManager);
        adapter = new Friend_Req_Adapter(friend_req_key_list,getActivity(),getContext());
        friend_req_RecylerView.setAdapter(adapter);
    }
